...
export class PoisonPowder extends Attack {
  ...
  constructor (scene) {
    ...
    this._attackGameObject1 = this._scene.add.sprite(0, 0, ATTACK_ASSET_KEYS.POISON_POWDER, 0)
  ...
  #createAnimation () {
    const anim = {
      ...
      frames: this._scene.anims.generateFrameNumbers(ATTACK_ASSET_KEYS.POISON_POWDER, { frames: [0, 1, 2, 3, 4, 5, 6]}),
      frameRate: 8,
      repeat: 0,
      yoyo: false
    }
